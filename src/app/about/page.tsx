...
export default function About() {
  return (
    <main className="min-h-screen pt-40 pb-24 bg-white relative overflow-hidden text-gray-700">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h1 className="mt-6 text-6xl md:text-8xl font-black text-black tracking-tighter leading-none">
            Building Growth For <br />
            <span className="text-[#0c6a22]">Modern Brands.</span>
          </h1>

          <p className="mt-12 text-xl md:text-2xl text-gray-600 max-w-3xl font-light leading-relaxed">
        ...
        <div className="mt-24 grid md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="bg-gray-50 border border-gray-200 p-10 rounded-3xl hover:border-[#0c6a22]/30 transition-all duration-500"
          >
          ...
          <motion.div
            ...
            className="bg-gray-50 border border-gray-200 p-10 rounded-3xl hover:border-[#0c6a22]/30 transition-all duration-500"
          >
            <h3 className="text-2xl font-bold text-black mb-6">Our Approach</h3>
            <p className="leading-relaxed">
