      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="text-gray-400 space-y-8 font-light leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-[#F97316] mb-4">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#F97316] mb-4">2. Data Collection</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#F97316] mb-4">3. Data Security</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#F97316] mb-4">4. Contact Us</h2>
              <p>If you have any questions regarding your data, please reach out to us at <span className="text-white">hello@239tbd.com</span>.</p>
            </section>
          </div>
        </motion.div>
      </div>
