...
export default function AboutPreview() {
  ...
  return (
    <section className="relative z-10 bg-[#050505] pt-16 lg:pt-24 pb-32 overflow-hidden flex flex-col gap-20">
      ...
      {/* CLEAN MARQUEE: Removed border and background strip */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-4 relative z-10">
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-5">
            <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="text-[#F97316] uppercase tracking-[0.2em] text-sm font-bold block mb-6">
              
            </motion.span>
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter text-white leading-[1.05]">
              Real Strategy. <br />
              <span className="text-[#F97316]">Real Growth.</span>
            </h2>
          </div>
          ...
          <div className="lg:col-span-7 w-full flex flex-col gap-8">
            {points.map((pointText, pointIndex) => (
              <div key={pointIndex} className="flex items-start gap-4">
                <span className="text-[#F97316] font-bold mt-1 text-2xl lg:text-3xl shrink-0">→</span>
                ...
                <motion.div
                  ...
                  className="text-xl md:text-2xl lg:text-3xl font-light leading-[1.3] tracking-tight w-full text-white"
                >
